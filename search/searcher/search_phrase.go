...
func init() {
	...
	search.HeapOverhead["PhraseSearcher"] = int(reflect.TypeOf(ps).Size()) + index.SizeOfPointer
}
...
func (s *PhraseSearcher) SizeInBytes() int {
	sizeInBytes := search.HeapOverhead["PhraseSearcher"] +
